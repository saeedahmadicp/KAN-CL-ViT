...
from kan import KANLayer as KANLayer_original
...
## CNN model for CIFAR-10 with KANLinear original
class CNNKAN_original(nn.Module):
    def __init__(self, device):
        super(CNNKAN_original, self).__init__()
        self.conv1 = nn.Conv2d(3, 32, kernel_size=3, padding=1)  
        self.pool1 = nn.MaxPool2d(2)
        self.conv2 = nn.Conv2d(32, 64, kernel_size=3, padding=1)
        self.pool2 = nn.MaxPool2d(2)
        
        self.kan1 = KANLayer_original(64 * 8 * 8, 256, device=device)
        self.kan2 = KANLayer_original(256, 10, device=device)
